...
export default function LoginScreen({ navigation }: Props) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setPayBusy(true);
      // Reference first, then the reference-free item lookup — so a payment
      // that settled without us hearing about it still signs the student in.
      ...
      // Only complain if the student actually came back from a checkout. A
      // silent background re-check that finds nothing is not an error.
